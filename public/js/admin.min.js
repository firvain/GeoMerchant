    ...
    estates: function estates() {
      return new ol.source.Vector({
        ...
        loader: function propertyLoader() {
          var url = 'www.geomerchant.eu/api/property/all/' + id;
          var self = this;
          Promise.resolve(
            $.ajax({
              url: url,
  ...
  function selectFeature(evt) {
    ...
    if (clickedFeature) {
      ...
      var p1 = Promise.resolve(
        $.ajax({
          url: 'www.geomerchant.eu/api/property',
          type: 'GET',
          data: {
            gid: gid
          }
      ...
      var p2 = Promise.resolve(
        $.ajax({
          url: 'www.geomerchant.eu/api/listing',
          type: 'GET',
          data: {
            gid: gid
          }
